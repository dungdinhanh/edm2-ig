...
#PBS -o output_nci/compress_guidance_edm2_skip5_scale1.0_k1_start16.txt
...
for efilter in "${efilters[@]}"
do
cmd="python calculate_metrics_args.py --gen_zip ${base_folder}/IntG/eFilter/compress_e${efilter}_s${scale}_skip${skip}_k${k}/reference/samples_50000x512x512x3.npz --ref_path ${base_folder}/reference/img512.pkl --metric fid --base_folder ${base_folder}"
echo ${cmd}
eval ${cmd}
